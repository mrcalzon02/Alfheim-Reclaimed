"""Verify fey-wildlife generator source reproduces the committed shipping artifacts.
...
every generated byte against the repository. It does not mutate the authoritative tree and
it does not claim runtime spawning or EntityJS acceptance.
"""
...
def self_test() -> int:
    ...
    print("self-test: isolated generated-output equality contract PASS")
    return 0
...
def main() -> int:
    ...
    print(
        ...
        f"{EXPECTED_GENERATED_FILES} generated files byte-identical)"
    )
    return 0
